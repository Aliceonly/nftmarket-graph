...
export class WithdarwProceedsCall extends ethereum.Call {
  get inputs(): WithdarwProceedsCall__Inputs {
    return new WithdarwProceedsCall__Inputs(this);
  }

  get outputs(): WithdarwProceedsCall__Outputs {
    return new WithdarwProceedsCall__Outputs(this);
  }
}

export class WithdarwProceedsCall__Inputs {
  _call: WithdarwProceedsCall;

  constructor(call: WithdarwProceedsCall) {
    this._call = call;
  }
}

export class WithdarwProceedsCall__Outputs {
  _call: WithdarwProceedsCall;
